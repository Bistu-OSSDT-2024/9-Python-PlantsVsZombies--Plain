...
class Level(tool.State):
    ...
    def addPlant(self):
        ...
        if self.plant_name == c.SUNFLOWER:
        ...
        elif self.plant_name == c.CRAZYDAVE:
            new_plant = plant.CrazyDave(x, y, self.bullet_groups[map_y])
            ...
            new_plant = plant.DoubleHeadSunflower(x, y)
        elif self.plant_name == c.DOUBLEHEADSUNFLOWER:
            new_plant = plant.DoubleHeadSunflower(x, y,self.sun_group)
